...
document.getElementById("boutonChangementMDP").addEventListener("click", function() {
    window.location.replace(`http://${serverIp}/keycloak/realms/CATS/protocol/openid-connect/auth?client_id=portal-cats&redirect_uri=http%3A%2F%2F${serverIp}%2Fview%2FUtilisateurs%2FinformationsUtilisateur.html&response_mode=fragment&response_type=code&scope=openid&nonce=e8f2162f-2d69-4ed5-b1fa-8931db645871&kc_action=UPDATE_PASSWORD&code_challenge=XbvFfVo7eZX4DJLtJITjMkOfICgQl4cOJy2AeF-vlIg&code_challenge_method=S256`);
});

document.getElementById("boutonCompteKeycloak").addEventListener("click", function() {
    window.location.replace(`http://${serverIp}/keycloak/realms/CATS/account/#/personal-info?client_id=portal-cats`); //Mettre le lien de redirection vers le compte keycloak
});
